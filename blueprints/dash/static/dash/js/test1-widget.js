...
$(".graph-tab").click(function(){
    ...
    if($(this).text() == "Linear"){
      if(myChart.options.scales.yAxes[0] != 'linear') {myChart.options.scales.yAxes[0] = {type: 'linear'}; myChart.update();}
    }else if($(this).text() == "Logarithmic"){
      if(myChart.options.scales.yAxes[0] != 'logarithmic') {myChart.options.scales.yAxes[0] = {type: 'logarithmic'}; myChart.update();}
    }
 });